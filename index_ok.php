...
<html lang="en">
    ...
    <body>
        <?php $page='inicio'; include 'php/lib-sitio_ok.php'; ?>
        <?php contenidoSitio(); ?>
        <!-- ==================================================================================================-->
        <div class="slider">
                                ...
                                <li>
                                    <div class="banner-info">
                                        ...
                                        <div class="col-md-5 agileinfo-grid grid-one">
                                            ...
                                            <p>Visite nuestro local y no se arrepentirá de nuestro servicio</p>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
                                </li>
                                <li>
                                    <div class="banner-info">
                                        ...
                                        <div class="col-md-5 agileinfo-grid grid-one">
                                            ...
                                            <p>Tenemos la mejor tecnología para brindarle el mejor servicio</p>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
                                </li>
                                <li>
                                    <div class="banner-info">
                                        ...
                                        <div class="col-md-5 agileinfo-grid grid-one">
                                            ...
                                            <p>Cualquier día, sin importar la hora, llámenos.
                                                <br>(757) 4772051 <br>(757) 1164264 <br> (757) 4767014 </p>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
                                </li>
