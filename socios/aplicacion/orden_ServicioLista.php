...
<!--ihmaribe@gmail.com institutohumanista-->
 ...
 <body>
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
          ...
          <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header success"><i class="fa fa-user-md"></i> Orden de servicio</h3>
                </div>
            </div>
                  <div class="col-lg-3" > 
          <a href="nuevaOrden.php" class="btn btn-info  " title="Agregar nueva orden de servicio"><i class='glyphicon glyphicon-plus'></i>Nueva orden de servicio</a>
      </div> <br><br>
