        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse large" id="navbarCollapse">
                <ul class="nav navbar-nav">
                    <li class="<?php if($page=='inicio'){echo 'active';}?>"><a href="index.php"><i class="fa fa-home"></i> Inicio</a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li class="divider"></li>
                            <li><a href="cliente_logout.php">Cerrar sesión</a></li>
                            <?php } else { ?>
                            <li class="divider"></li>
                            <li><a href="cliente_login.php">Inicia sesión</a></li>
            ...
            </div> <!--termina el MENU NAVBAR-COLLAPSE -->
