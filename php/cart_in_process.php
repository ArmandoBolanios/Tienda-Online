...
if($action == 'ajax'){
	...
	$cart_paid = "
		...
		AND aux = '1' ORDER BY fechaDeRegistro LIMIT $offset,$per_page
		";
...
<table class="table table-bordered">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<a href="cliente_historial_pedidos-proceso2.php?idVenta=<?php echo $row['idVenta'];?>">
